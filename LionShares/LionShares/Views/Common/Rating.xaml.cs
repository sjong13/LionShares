...
namespace LionShares
{
    ...
    {
        private string RATING_EMPTY_ICON_CHAR = FontAwesomeFont.StarO;
        private string RATING_PARTIAL_ICON_CHAR = FontAwesomeFont.StarHalf;
        private string RATING_FULL_ICON_CHAR = FontAwesomeFont.Star;
